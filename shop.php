...
<head>
    ...
    <meta property="og:title" content="Trang bán hàng || Công ty TNHH Sản xuất Thương mại Samry sản xuất nút áo, phôi nút và các loại trang sức thì vỏ ốc biển">
    <meta property="og:description" content="Tham quan những mặt hàng mới nhất, trải nghiệm khám phá các trang sức tuyệt đẹp từ vỏ ốc">
...
">
    ...
    <meta name="twitter:title" content="Trang bán hàng || Công ty TNHH Sản xuất Thương mại Samry sản xuất nút áo, phôi nút và các loại trang sức thì vỏ ốc biển">
    <meta name="twitter:description" content="Tham quan những mặt hàng mới nhất, trải nghiệm khám phá các trang sức tuyệt đẹp từ vỏ ốc">
    ...
    <link rel="canonical" href="<?php
                                ...
                                echo $current_url;
                                ?>">
    <title>Sản phẩm || Công ty TNHH SX-TM Samry</title>
                                    ...
                                    <div class="shopping-option-item">
                                        ...
                                        <ul class="sidebar-list">
                                            <?php foreach ($categorylist as $category) : ?>
                                                <li><a href="<?php echo "?category=" . $category['categoryproduct_id']; ?>" data-category="<?php echo $category['categoryproduct_id'];  ?>"><?php echo $category['name']; ?></a></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                    <style>
                                    ...
                                    <?php foreach ($showlistcart_wl as $showlistcat) : ?>
                                        <div class="single-product-item">
                                            <figure class="product-thumb">
                                                <a href="single-product.php?productid=<?php echo $showlistcat['id'] ?>"><img class="mr-2 img-fluid" src="<?php echo '/admin-page' . mb_substr($showlistcat['image'], 2); ?>" alt="Products" /></a>
                                            </figure>
                                            <div class="product-details">
                                                <h2><a href="single-product.php?productid=<?php echo $showlistcat['id'] ?>"><?php echo $showlistcat['name'] ?></a></h2>
                            ...
                            <div class="sidebar-body">
                                <div class="small-product-list">
                                    <?php foreach ($products_most as $productshowyk) : ?>
                                        <div class="single-product-item">
                                            <figure class="product-thumb">
                                                <a href="single-product.php?productid=<?php echo $productshowyk['id'] ?>"><img class="mr-2 img-fluid" src="<?php echo '/admin-page' . mb_substr($productshowyk['image'], 2); ?>" alt="Products" /></a>
                                            </figure>
                                            <div class="product-details">
                                                <h2><a href="single-product.php?productid=<?php echo $productshowyk['id'] ?>"><?php echo $productshowyk['name'] ?></a></h2>
                                        ...
                                        <div class="col-lg-4 col-sm-6 sort_product_by_select" id="<?php echo $product['id']  ?>">
                                            ...
                                            <div class="single-product-item text-center">
                                                ...
                                                <div class="product-details product-filter-category" data-category="<?php if (isset($_GET['category'])) {
                                                    ...
                                                    <p class="products-desc"><?php echo $product['short_description']; ?></p>
                            ...
                            <script>
                                ...
                                document.getElementById('filterBtn').addEventListener('click', function() {
                                    ...
                                    if (category) {
                                        ...
                                        var url = "?minprice=" + minPrice + "&maxprice=" + maxPrice + "&category=" + category;
                                    } else {
                                        // Đường dẫn tới trang shopfilter chỉ với các tham số minprice và maxprice
                                        var url = "?minprice=" + minPrice + "&maxprice=" + maxPrice;
                                    }
