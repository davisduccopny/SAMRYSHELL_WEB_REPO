...
<head>
    ...
    <title>My account || Trang cá nhân - Samryvn</title>
    <meta name="description" content="Đăng nhập tài khoản cá nhân | Liên hệ hỗ trợ: support@samryvn.com, samryvn@gmail.com">
    <!-- START SEO JSON -->
    <script type="application/ld+json">
        {
            ...
            "url": "https://samryvn.com/my-account/tai-khoan-cua-toi.html",
                ...
                <div class="col-12 text-center">
                    <div class="page-title-content">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li><a href="<?php echo $current_url_PAGE; ?>" class="active">Dashboard</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="tab-content" id="myaccountContent">
                                    ...
                                    <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                        <div class="myaccount-content">
                                            ...
                                            <div class="welcome">
                                                <p>Hello, <strong><?php echo $getCTM['name'] ?></strong> (If Not <strong><?php echo $getCTM['name'] ?> !</strong><a href="login-register.php" class="logout"> Logout</a>)</p>
                                            </div>
                                                        ...
                                                        <?php if (count($getSale) > 0) : ?>
                                                            ...
                                                            <?php foreach ($getSale as $getSale_show) : ?>
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo $current_url_PAGE; ?>" class="btn-add-to-cart">View</a></td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                                        <?php else : ?>
                                                            <tr>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>Aug 22, 2018</td>
                                                            <td>Yes</td>
                                                            <td><a href="<?php echo $current_url_PAGE; ?>" class="btn-add-to-cart">Download File</a></td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="single-input-item">
                                                                ...
                                                                <input type="text" id="fullname_update" placeholder="First Name" value="<?php echo $getCTM['name']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 ">
                                                            <div class="single-input-item">
