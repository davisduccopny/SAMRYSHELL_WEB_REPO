...
$(document).ready(function () {
        ...
        series: [
          {
            ...
            type: "column",
            data: [
              100, 150, 80, 180, 150, 175, 201, 60, 200, 120, 190, 160, 50,
            ],
          },
          {
            name: "Pending",
  ...
  if ($("#sales_charts").length > 0) {
    var salesData = JSON.parse($("#Total_sale_by_month").val());
    var expensesData = JSON.parse($("#Total_expense_by_month").val());
