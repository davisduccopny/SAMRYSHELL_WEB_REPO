...
<?php
if (isset($_GET['user_customerid'])) {
    $id = $_GET['user_customerid'];
    require '../model/usercustomer_model.php';
    $usercustomermodel = new UserCustomerModel($conn);
    $GETusercustomer = $usercustomermodel ->  getUserCustomer($id);
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        if (isset($_POST['submit'])) {
            ...
            $userupdate = $usercustomermodel-> updateUserCustomer($id, $firstnameuser, $lastnameuser,$emailcustomeruser) ;
            if ($userupdate) {
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Chỉnh sửa thông tin user khách hàng</h4>
                    ...
                    <form method="post" enctype="multipart/form-data" class="row">
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Họ</label>
                                    <input type="text" name="firstnameuser" value="<?php echo $GETusercustomer['first_name']?>">
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Tên</label>
                                    <input type="text" name="lastnameuser" value="<?php echo $GETusercustomer['last_name']?>">
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Email khách hàng</label>
                                    <input type="text" id="emailInput" placeholder="Enter customer email" name="emailcustomeruser" value="<?php echo $GETusercustomer['email']?>">
