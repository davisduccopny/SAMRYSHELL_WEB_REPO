            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        ...
                        <h6>View/Search Blog</h6>
                    </div>
                    <div class="page-btn">
                        <a href="addblog.php" class="btn btn-added">
                            <img src="assets/img/icons/plus.svg" class="me-1" alt="img">Thêm bài viết
                        </a>
                    </div>
                </div>
                            ...
                            <table class="table  datanew">
                                ...
                                <?php foreach ($Blogs as $blog): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="me-3" href="editblog.php?blog_id=<?php echo $blog['id']; ?>">
