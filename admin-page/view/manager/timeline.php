            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="components.php"><img src="assets/img/icons/product.svg" alt="img"><span>
                                    Components</span> </a>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/expense1.svg" alt="img">
                                <span>Elements </span> <span class="menu-arrow"></span></a>
                            <ul>
