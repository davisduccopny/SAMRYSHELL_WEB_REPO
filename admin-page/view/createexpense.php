...
<?php require_once('./main/head.php'); ?>
    ...
    <link rel="stylesheet" href="../tinymce/js/tinymce/skins/ui/oxide-dark/skin.min.css">
...
<body>
    ...
    <script>
  tinymce.init({
    selector: '#textdescriptioncategory'
    // plugins: "BootstrapEditor",
    // apiKey: "APIKEY12"
 // ID của phần tử textarea bạn muốn biến đổi thành trình soạn thảo TinyMCE.
  });
</script>
    <script>
