    ...
    if (isset($_GET['blog_id'])){
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $created_by_blog = $_SESSION['email_manager'];
                ...
                $categoryupdate = $blogModel->updateBlog_info($blog_id,$name_blog,$description_blog,$content_blog,$created_by_blog,$image_blog,$image_blog_tmp);
                if ($categoryupdate) {
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Chỉnh sửa thông tin trang</h4>
                        <h6>Edit</h6>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <form class="row" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Ảnh bìa (không khuyển khích chọn)</label>
