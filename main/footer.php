                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="follow-content-wrap">
                            <a href="index.php" class="logo"><img src="assets/img/samryshell-logo-black.png" style="width: 88px;height:auto;" alt="logo" /></a>
                            <p>CÔNG TY TNHH SẢN XUẤT THƯƠNG MẠI SAMRY</p>

                            <div class="container py-4" style="text-transform: uppercase;font-size:small;">
                                <div class="row gy-4 gx-5">
                                    ...
                                    <div class="col-lg-2 col-md-6">
                                        <ul class="list-unstyled text-white-colorsumtime">
                                            <li><a href="index.php" class="text-white-colorsumtime">Trang chủ</a></li>
                                            <li><a href="shop.php" class="text-white-colorsumtime">Mua hàng</a></li>
                                            <li><a href="about.php?blog_id=12" class="text-white-colorsumtime">Về chúng tôi</a></li>
                                            <li><a href="blog.php" class="text-white-colorsumtime">Tin Tức</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-2 col-md-6" style="white-space: nowrap;">
                                        <ul class="list-unstyled text-white-colorsumtime">
                                            <li><a href="about.php?blog_id=11" class="text-white-colorsumtime">Lịch sử hình thành</a></li>
                                            <li><a href="about.php?blog_id=15" class="text-white-colorsumtime">Chính sách bán hàng</a></li>
                                            <li><a href="about.php?blog_id=16" class="text-white-colorsumtime">Chính sách vận chuyển</a></li>
                                            <li><a href="contact.php" class="text-white-colorsumtime">Liên Hệ</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
...
<script type="text/javascript">
    ...
    (function() {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/661d66661ec1082f04e29c64/1hrhdg0jl';
        s1.charset = 'UTF-8';
