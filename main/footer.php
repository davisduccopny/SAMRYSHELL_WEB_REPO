<section class="call-buton"><a class="cc-calto-action-ripple" href="tel:<?php echo $generalListshow['phone']; ?>"><i class="fa fa-phone"></i><span class="num">
            <?php echo mb_substr($generalListshow['phone'], 0, 3) . '.' . mb_substr($generalListshow['phone'], 4, 3) . '.' . mb_substr($generalListshow['phone'], 7, 3). '.' . mb_substr($generalListshow['phone'], 10, 3); ?>
        </span>
    </a>
</section>
