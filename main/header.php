                ...
                <div class="main-menu-wrap">
                    <nav id="mainmenu">
                        <ul>
                            ...
                            <li><a href="about.php?blog_id=12">Giới thiệu</a>
                            </li>
                            <li class="dropdown-show"><a href="#">Thông tin</a>
                                <ul class="dropdown-nav">
                                    <?php foreach ($ListBlog as $ListBlogmenu) : ?>
                                        <li><a href="about.php?blog_id=<?php echo $ListBlogmenu['id']; ?>"><?php echo $ListBlogmenu['name']; ?></a></li>
                                    <?php endforeach; ?>
                            ...
                            <li class="dropdown-show"><a href="#">Danh mục</a>
                                <ul class="mega-menu-wrap dropdown-nav">
                                    <li class="mega-menu-item"><a href="shop.php" class="mega-item-title">Sản phẩm</a>
                                        <ul>
                                            <?php foreach ($listcategoryMenu as $listmenucategory) : ?>
                                                <li><a href="shop.php?category=<?php echo $listmenucategory['categoryproduct_id']; ?>"><?php echo $listmenucategory['name']; ?></a></li>
                                            <?php endforeach; ?>
                                        </ul>
                    ...
                    <ul>
                        ...
                        <li class="settings"><a href="#"><i class="fa fa-cog"></i></a>
                            <div class="site-settings d-block d-sm-flex">
                                ...
                                <dl class="my-account">
                                    <dt>Tài khoản</dt>
                                    <dd><a href="my-account.php">Dashboard</a></dd>
                                    <dd><a href="my-account.php#account-info">Profile</a></dd>
                                    <dd><a href="#">Sign</a></dd>
                                </dl>
